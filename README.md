...
A casual German language learning app for practicing vocabulary, nouns (gender/declension), verbs (conjugation across 7 tenses), and adjectives (declension/comparison). Built as a monorepo with a React Native [Android app](builds/german-practice.apk), a [web app](https://german-practice.pages.dev), a terminal CLI, and an AI-powered vocabulary generator.

> **Apple users:** There is no iOS app at this time. Please use the [web app](https://german-practice.pages.dev) instead.
